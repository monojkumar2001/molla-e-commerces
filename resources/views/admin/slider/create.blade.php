                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="slider_short_title"
                                            name="slider_short_title" autocomplete="off" placeholder="Enter Short Title">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="description" class="form-label">Description</label>
                                        <textarea class="form-control" name="description" id="description" type="text"id="tinymceExample" placeholder="Enter description" cols="30"
                                            rows="10"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" placeholder="Meta description" name="meta_description" type="text"id="tinymceExample" cols="30" rows="10"></textarea>
                                    </div>
                                </div>
                                <div class="mb-3">
