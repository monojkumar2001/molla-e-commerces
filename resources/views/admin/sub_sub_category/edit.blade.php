                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $sub_sub_category->meta_title }}"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="description" id="tinymceExample" cols="30" rows="10">{{ $sub_sub_category->description }}</textarea>
                                    </div>
                                </div>
                                <div class="mb-3">
