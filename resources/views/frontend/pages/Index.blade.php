                            ...
                            <div class="row justify-content-center">
                                    ...
                                    <div class="product product-11 mt-v3 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="product-nav product-nav-dots">
                                                <a href="#" class="active" style="background: #333333;"><span
                                                        class="sr-only">Color name</span></a>
                                                <a href="#" style="background: #927764;"><span
                                                        class="sr-only">Color name</span></a>
                                            </div><!-- End .product-nav -->
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-title"><a href="product.html">Original Outdoor Beanbag</a>
                                            </h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $259,00
                                            </div><!-- End .product-price -->
                    ...
                    <div class="owl-carousel owl-simple carousel-with-shadow" data-toggle="owl"
                        ...
                        <article class="entry entry-display">
                            ...
                            <div class="entry-body pb-4 text-center">
                                ...
                                <div class="entry-content">
                                    <p>Suspendisse potenti. Sed egestas, ante et vulputate volutpat, eros pede semper est,
